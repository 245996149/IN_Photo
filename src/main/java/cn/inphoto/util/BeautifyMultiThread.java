...
public class BeautifyMultiThread {
     ...
     * return 美颜后的图片
     */
    public BufferedImage beautifyImg(BufferedImage image, int sigma) {
        ...
        image.getRGB(0, 0, width, height, src_pixels, 0, width);
//        bit.getPixels(src_pixels, 0, width, 0, 0, width, height);
        ...
        BufferedImage resImage = new BufferedImage(width, height, BufferedImage.TYPE_USHORT_565_RGB);
//        Bitmap resImg = Bitmap.createBitmap(width, height, Bitmap.Config.RGB_565);
//        resImg.setPixels(src_pixels, 0, width, 0, 0, width, height);
        resImage.setRGB(0, 0, width, height, src_pixels, 0, width);
        return resImage;
    }
    ...
    public void testa() throws IOException {
        BufferedImage bimg = ImageIO.read(new File("/home/ming/1501666483.png"));
        BufferedImage a = beautifyImg(bimg, 10);
        ImageIO.write(a, "png", new File("/home/ming/1111111111.png"));
    }
}
