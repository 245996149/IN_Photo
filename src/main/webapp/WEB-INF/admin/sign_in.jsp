...
<div class="row">
    <div class="col-md-offset-2 col-md-8">
        <div class="alert alert-danger" role="alert" id="error_div" style="text-align: center;display: none;">
            检测到您的浏览器可能有部分组件无法使用，请使用<strong>Chrome内核</strong>的浏览器
    ...
    <form class="form-signin" id="signin_form" method="post">
        ...
        <div class="input-group input-group-lg">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <input type="text" hidden id="login_type" name="login_type" value="0">
                </c:otherwise>
            </c:choose>
