...
<div class="container">
    ...
    <form class="form-signin" id="signin_form" action="${pageContext.request.contextPath}/admin/index.do" method="post">
        <h2 class="form-signin-heading">IN Photo后台管理员系统</h2>
