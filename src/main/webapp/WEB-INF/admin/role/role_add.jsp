    ...
    <div class="col-md-offset-4 col-md-4 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post" action="${pageContext.request.contextPath}/admin/roleManage/addRole.do">
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon" id="id_span">角色名称</span>
                            ...
                            <div class="checkbox">
                                <c:forEach items="${moduleList}" var="m">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="moduleIds" value="${m.moduleId}"> ${m.name}
                                    </label>
                                </c:forEach>
                            </div>
                        </div>
